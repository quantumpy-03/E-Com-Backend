...
class UserAddress(models.Model):
    ...
    country = models.CharField(verbose_name=_("Country"), max_length=50, null=False, blank=False)
    state = models.CharField(verbose_name=_("State"), max_length=100, null=False, blank=False)
    city = models.CharField(verbose_name=_("City"), max_length=100, null=False, blank=False)
    door_number = models.CharField(verbose_name=_("Door number"), max_length=100, null=False, blank=False)
    street = models.CharField(verbose_name=_("Street"), max_length=100, null=False, blank=False)
    pincode = models.CharField(verbose_name=_("Pincode"), max_length=10, null=False, blank=False)
...
class ProductCategory(models.Model):
    category_name = models.CharField(verbose_name=_("Category Name"), max_length=255, unique=True, null=False, blank=False)
    category_description = models.TextField(verbose_name=_("Category Description"), max_length=255, null=True, blank=True)
